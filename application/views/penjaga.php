...
<audio id="suarabelnomorurut" src="<?php echo base_url('audio/antrian/nomor-urut.mp3'); ?>"></audio>
		...
		<div class="box">
			...
			<div class="agenda">
				...
				<center>
					...
					<a onclick="return confirm('Yakin akan mengambil no antrian lagi ?  Pastikan no sebelumnya sudah terpanggil')" href="<?php echo site_url('penjaga/antrian_selanjutnya') . '/' . $this->session->userdata('username'); ?>" class="btn selanjutnya" type="submit"><i class="glyphicon glyphicon-play"></i> &nbsp;Antrian Selanjutnya</a>
				</center>
				<br>
			</div>
		</div>
